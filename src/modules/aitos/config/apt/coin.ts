...
export const APT: APTCoin = {
  coinType: "0x1::aptos_coin::AptosCoin",
  coinName: "Aptos",
  coinSymbol: "APT",
  decimals: 8,
  description:
    "Aptos Coin (APT) is the native cryptocurrency of the Aptos blockchain. It is used for transaction fees, staking, and governance within the Aptos ecosystem.",
};

export const zUSDC: APTCoin = {
  coinType:
  ...
  decimals: 6,
  description:
    "zUSDC is from layer zero . USD Coin (USDC) is a stablecoin that aims to maintain a 1:1 peg with the US dollar. It is backed by reserves of US dollars and is widely used in the cryptocurrency ecosystem for trading, remittances, and as a stable store of value.",
};

export const USDC: APTCoin = {
  coinType:
  ...
  decimals: 6,
  description:
    "USD Coin (USDC) is a stablecoin that aims to maintain a 1:1 peg with the US dollar. It is backed by reserves of US dollars and is widely used in the cryptocurrency ecosystem for trading, remittances, and as a stable store of value.",
};

export const AMI: APTCoin = {
  coinType:
  ...
  decimals: 8,
  description:
    "AMI is the governance token of Amnis, a DAO operating on the Aptos blockchain. Amnis is the protocol that created amAPT and stAPT, liquid staking tokens representing staked APT in the Amnis stake pool.",
};

export const THL: APTCoin = {
  coinType:
